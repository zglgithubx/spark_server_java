...
public class RSAUtil {
    ...
    public static Map<String,String> privateKeyMap=new HashMap<>();
    ...
    private static final String SRC = String.valueOf(new Date().getTime());

    public static void main(String[] args) throws Exception {
        System.out.println("\n");
        RsaKeyPair keyPair = generateKeyPair();
        System.out.println("pubKey:" + keyPair.getPublicKey());
        System.out.println("priKey:" + keyPair.getPrivateKey());
        System.out.println("\n");
        test1(keyPair);
        System.out.println("\n");
        test2(keyPair);
    ...
    private static void test1(RsaKeyPair keyPair) throws Exception {
        ...
        System.out.println(RSAUtil.SRC.equals(text2));
